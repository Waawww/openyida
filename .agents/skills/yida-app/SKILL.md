...
```bash
node .Codex/skills/yida-create-app/scripts/create-app.js "<应用名称>" "[描述]"
```
...
```bash
node .Codex/skills/yida-create-page/scripts/create-page.js "<appType>" "<页面名称>"
```
...
```bash
node .Codex/skills/yida-create-form-page/scripts/create-form-page.js create "<appType>" "<表单名称>" .Codex/skills/yida-create-form-page/scripts/fields.json
```
