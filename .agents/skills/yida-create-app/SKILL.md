...
```bash
node .Codex/skills/yida-create-app/scripts/create-app.js <appName> [description] [icon] [iconColor]
```
...
```bash
# 最简用法
node .Codex/skills/yida-create-app/scripts/create-app.js "考勤管理"

# 完整参数
node .Codex/skills/yida-create-app/scripts/create-app.js "考勤管理" "员工考勤打卡系统" "xian-daka" "#00B853"
```
