...
```bash
node .Codex/skills/yida-create-form-page/scripts/create-form-page.js create <appType> <formTitle> <fieldsJsonOrFile>
```
...
```bash
node .Codex/skills/yida-create-form-page/scripts/create-form-page.js create "APP_xxx" "图片生成表" .Codex/skills/yida-create-form-page/scripts/fields.json
```
...
```bash
node .Codex/skills/yida-create-form-page/scripts/create-form-page.js update <appType> <formUuid> <changesJsonOrFile>
```
...
```bash
node .Codex/skills/yida-create-form-page/scripts/create-form-page.js update "APP_xxx" "FORM-yyy" '[{"action":"add","field":{"type":"TextField","label":"备注"}}]'
```

**示例（JSON 文件）**：

```bash
node .Codex/skills/yida-create-form-page/scripts/create-form-page.js update "APP_xxx" "FORM-yyy" changes.json
```
